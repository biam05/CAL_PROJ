...
A aplicação deve ser capaz de determinar a acessibilidade aos pontos de depósito/recolha.[1]

\begin{itemize}
	\item \textbf{1ª Abordagem: Ponto de Recolha Mais Próximo}
...
\begin{itemize}
	\item \textbf{2ª Abordagem: Ponto de Recolha de um Determinado Resíduo Mais Próximo}
...
\begin{itemize}
	\item \textbf{3ª Abordagem: Ponto de Recolha de um Determinado Resíduo Mais Próximo com Capacidade Suficiente}	
...
\begin{itemize}
	\item \textbf{4ª Abordagem: Implementação Paralela do Modelo de Negócio}	
