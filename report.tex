...
\begin{figure}[h!]
  ...
  \caption{Exemplo de um grafo vizualidade no \textit{GraphViewer}.}
\end{figure}
...
Figura 1: GitHub. (2020). \textit{STEMS-group/GraphViewer}. [online] Disponível em: \url{https://github.com/STEMS-group/GraphViewer}.
